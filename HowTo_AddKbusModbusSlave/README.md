...
$cp ./ptxproj/src/kbusmodbusslave-1.5.0.tar.bz2 ~/wago/ptxproj/src/
```
...
4. Build package or complete image
    ...
    Afterwards you should find the IPKG installer package file:
        ~/wago/ptxproj/platform-wago-pfcXXX/packages/kbusmodbusslave_1.5.0_armhf.ipk
...
- transfer package "kbusmodbusslave_1.5.0_armhf.ipk" into PFC's file system and call "opkg install <pkg-name>.ipk"
...
```
    ...
    $scp kbusmodbusslave_1.5.0_armhf.ipk root@<IP-of-PFC>:/root
    root@<IP-of-PFC>'s password:  # Enter the root password (default: wago)
    kbusmodbusslave_1.5.0_armhf.ipk               100%   23KB  23.3KB/s   00:00
```
...
```
    $ opkg install kbusmodbusslave_1.5.0_armhf.ipk
    Installing kbusmodbusslave (1.5.0) on root.
...
```
    ...
    Select package to install or update, here "kbusmodbusslave_1.5.0_armhf.ipk".
```
