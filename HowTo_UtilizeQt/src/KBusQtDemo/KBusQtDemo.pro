...
wago_pfc{ # Wago specific code, like the inlude Paths and Libraries
    ...
    exists($$SYSROOT_TARGET){ # Check Environment Variable SYSROOT_TARGET
        message("Target_Sysroot gefunden: $$SYSROOT_TARGET")
        INCLUDEPATH += $${SYSROOT_TARGET}/usr/include/OsLinux/ # Inlude OsLinux by default
        INCLUDEPATH += $${SYSROOT_TARGET}/usr/include/dal/     # Include dal by default
    } else {
